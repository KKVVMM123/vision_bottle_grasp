...
const int CAN_CHANNEL_COUNT = 8;

extern int left_h_id,left_m_id,left_l_id,right_h_id,right_m_id,right_l_id;
...
int socketcan_getcsp(int channel, int cannum, uint32_t *can_idlist, uint8_t command, int *data);
